...
function functionDay() {
    ...
    stripe4.forEach((element) => element.style.backgroundColor = "var(--window-color4)");
    ...
    stripe5.forEach((element) => element.style.backgroundColor = "var(--window-color3)");
    fBuilding3Section1.style.backgroundColor = "var(--building-color1)";
    stripe6.forEach((element) => element.style.backgroundColor = "var(--window-color1)");
    ...
    bubble1.forEach((element) => element.style.backgroundColor = "var(--window-color1)");
    fBuilding5.style.backgroundColor = "var(--building-color2)";
    stripe7.forEach((element) => element.style.backgroundColor = "var(--window-color2)");
    fBuilding6.style.backgroundColor = "var(--building-color3)";
    stripe8.forEach((element) => element.style.backgroundColor = "var(--window-color3)");
    bBuilding1Sec1.style.background = "linear-gradient( var(--building-color1), var(--window-color1))";
    bBuilding1Sec2.style.background = "linear-gradient( var(--building-color1), var(--window-color1))";
    bBuilding1Sec3.style.background = "linear-gradient( var(--building-color1), var(--window-color1))";
    bBuilding1Sec4.style.background = "linear-gradient( var(--building-color1) 50%, var(--window-color1))";
    bBuilding2Sec1.style.borderBottom = "5vh solid var(--building-color2)";
    bBuilding2Sec2.style.backgroundColor = "var(--building-color2)";
    stripe1.forEach((element) => element.style.backgroundColor = "var(--window-color2)");
    bBuilding3.style.backgroundColor = "var(--building-color3)";
    stripe2.forEach((element) => element.style.background = "linear-gradient(90deg, var(--building-color3) -45%, var(--window-color3) 100%)");
...
function functionNight() {
    ...
    stripe4.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    ...
    stripe5.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    fBuilding3Section1.style.backgroundColor = "var(--dark-background)";
    stripe6.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    ...
    bubble1.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    fBuilding5.style.backgroundColor = "var(--dark-background)";
    stripe7.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    fBuilding6.style.backgroundColor = "var(--dark-background)";
    stripe8.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    bBuilding1Sec1.style.background = "linear-gradient( var(--dark-background), var(--grey-background))";
    bBuilding1Sec2.style.background = "linear-gradient( var(--dark-background), var(--grey-background))";
    bBuilding1Sec3.style.background = "linear-gradient( var(--dark-background), var(--grey-background))";
    bBuilding1Sec4.style.background = "linear-gradient( var(--dark-background) 50%, var(--grey-background))";
    bBuilding2Sec1.style.borderBottom = "5vh solid var(--dark-background)";
    bBuilding2Sec2.style.backgroundColor = "var(--dark-background)";
    stripe1.forEach((element) => element.style.backgroundColor = "var(--grey-background)");
    bBuilding3.style.backgroundColor = "var(--dark-background)";
    stripe2.forEach((element) => element.style.background = "linear-gradient(90deg, var(--dark-background) -45%, var(--grey-background) 100%)");
